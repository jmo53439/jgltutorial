...
public class Hierarchy extends Tutorial {
    ...
    private class Armature {
        ...
        void drawLowerArm(MatrixStackf modelToCameraStack) {
            ...
            modelToCameraStack.scale(new Vector3f(widthLowerArm / 2.0f,
                    widthLowerArm / 2.0f, lenLowerArm / 2.0f));
            glUniformMatrix4fv(modelToCameraMatrixUnif, false, modelToCameraStack.get(mat4Buffer));
            glDrawElements(GL_TRIANGLES, indexData.length, GL_UNSIGNED_SHORT, 0);
            modelToCameraStack.popMatrix();
        ...
        void drawWrist(MatrixStackf modelToCameraStack) {
            ...
            modelToCameraStack.pushMatrix();
            modelToCameraStack.scale(new Vector3f(widthWrist / 2.0f,
                    widthWrist / 2.0f, lenWrist / 2.0f));
            glUniformMatrix4fv(modelToCameraMatrixUnif, false, modelToCameraStack.get(mat4Buffer));
            glDrawElements(GL_TRIANGLES, indexData.length, GL_UNSIGNED_SHORT, 0);
            modelToCameraStack.popMatrix();
        ...
        void drawFingers(MatrixStackf modelToCameraStack) {
            ...
            modelToCameraStack.scale(new Vector3f(widthFinger / 2.0f,
                    widthFinger / 2.0f, lenFinger / 2.0f));
            glUniformMatrix4fv(modelToCameraMatrixUnif, false, modelToCameraStack.get(mat4Buffer));
            glDrawElements(GL_TRIANGLES, indexData.length, GL_UNSIGNED_SHORT, 0);
            modelToCameraStack.popMatrix();
        ...
        void adjBase(boolean increment) {
            ...
            final float scale = 5;
            angBase += increment ? STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale :
                    -STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale;
        ...
        void adjUpperArm(boolean increment) {
            ...
            final float scale = 5;
            angUpperArm += increment ? STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale :
                    -STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale;
        ...
        void adjLowerArm(boolean increment) {
            ...
            final float scale = 5;
            angLowerArm += increment ? STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale :
                    -STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale;
        ...
        void adjWristPitch(boolean increment) {
            ...
            final float scale = 5;
            angWristPitch += increment ? STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale :
                    -STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale;
        ...
        void adjWristRoll(boolean increment) {
            ...
            final float scale = 5;
            angWristRoll += increment ? STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale :
                    -STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale;
        ...
        void adjFingerOpen(boolean increment) {
            ...
            final float scale = 5;
            angFingerOpen += increment ? STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale :
                    -STANDARD_ANGLE_INCREMENT * lastFrameDuration * scale;
