...
public class Translation extends Tutorial {
    ...
    private class OvalOffset extends Instance {
        ...
        Vector3f calcOffset(float elapsedTime) {
            ...
            return new Vector3f((float)(Math.cos(currTimeThroughLoop * scale) * 4.f),
                    (float)(Math.sin(currTimeThroughLoop * scale) * 6.f), -20.0f);
        }
    }
    ...
    private class BottomCircleOffset extends Instance {
        ...
        Vector3f calcOffset(float elapsedTime) {
            ...
            return new Vector3f((float)(Math.cos(currTimeThroughLoop * scale) * 5.f), -3.5f,
                    (float)(Math.sin(currTimeThroughLoop * scale) * 5.f - 20.0f));
        }
    }
