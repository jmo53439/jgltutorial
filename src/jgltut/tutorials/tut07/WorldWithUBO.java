...
public class WorldWithUBO extends Tutorial {
    ...
    private void initializeProgram() {
        ...
        uniformColor = loadProgram("PosOnlyWorldTransformUBO.vert",
                "ColorUniform.frag");
        objectColor = loadProgram("PosColorWorldTransformUBO.vert",
                "ColorPassthrough.frag");
        uniformColorTint = loadProgram("PosColorWorldTransformUBO.vert",
        ...
        glBindBuffer(GL_UNIFORM_BUFFER, 0);
        glBindBufferRange(GL_UNIFORM_BUFFER, globalMatricesBindingIndex,
                globalMatricesUBO, 0, 16 * 4 * 2);
    }
    ...
    private void drawParthenon(MatrixStackf modelMatrix) {
        ...
        for(int columnNum = 0; columnNum < (int) (parthenonWidth / 2.0f); columnNum++) {
            ...
            {
                modelMatrix.pushMatrix();
                modelMatrix.translate((2.0f * columnNum) - (parthenonWidth / 2.0f) +
                        1.0f, parthenonBaseHeight, frontZVal);
        ...
        {
            modelMatrix.pushMatrix();
            modelMatrix.translate(0.0f, parthenonColumnHeight + parthenonBaseHeight +
                    (parthenonTopHeight / 2.0f), parthenonLength / 2.0f);
