...
public class AmbientLighting extends Tutorial {
    ...
    protected void display() {
        ...
        
        {
            ...
            // render ground plane
            {
                ...
                glUseProgram(whiteDiffuse.theProgram);
                glUniformMatrix4fv(whiteDiffuse.modelToCameraMatrixUnif,
                        false, modelMatrix.get(mat4Buffer));
                Matrix3f normMatrix = new Matrix3f(modelMatrix);
                glUniformMatrix3fv(whiteDiffuse.normalModelToCameraMatrixUnif,
            ...
            // render cylinder
            {
                ...
                if(drawColoredCyl) {
                    ...
                    glUseProgram(vertexDiffuse.theProgram);
                    glUniformMatrix4fv(vertexDiffuse.modelToCameraMatrixUnif,
                            false, modelMatrix.get(mat4Buffer));
                    Matrix3f normMatrix = new Matrix3f(modelMatrix);
                    glUniformMatrix3fv(vertexDiffuse.normalModelToCameraMatrixUnif,
                            false, normMatrix.get(mat3Buffer));
    ...
    private void initializeProgram() {
        ...
        whiteDiffuseColor = loadProgram("DirVertexLighting_PN.vert",
                "ColorPassthrough.frag");
        vertexDiffuseColor = loadProgram("DirVertexLighting_PCN.vert",
                "ColorPassthrough.frag");
        whiteAmbDiffuseColor = loadProgram("DirAmbVertexLighting_PN.vert",
                "ColorPassthrough.frag");
        vertexAmbDiffuseColor = loadProgram("DirAmbVertexLighting_PCN.vert",
                "ColorPassthrough.frag");
    }
    ...
    private ProgramData loadProgram(String vertexShaderFileName, String fragmentShaderFileName) {
        ...
        data.normalModelToCameraMatrixUnif = glGetUniformLocation(data.theProgram,
