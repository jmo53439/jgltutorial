...
public class DdsLoader {
    ...
    public static ImageSet loadFromFile(String ddsFilepath) throws IOException {
        ...
        if(magicTest != MagicNumbers.DDS_MAGIC_NUMBER)
            throw new DdsFileMalformedException(ddsFilepath,
                    "The Magic number is missing from the file.");
        
        if(ddsFile.length < DdsHeader.BYTES + 4)
            throw new DdsFileMalformedException(ddsFilepath,
                    "The data is way too small to store actual information.");
        ...
        ImageCreator imageCreator = new ImageCreator(new ImageFormat(
                ddsFormat), ddsDimensions, numMipmaps, numArrays, numFaces);
    ...
    private static class DdsHeader {
        ...
        static final int BYTES = Integer.BYTES * (7 + 11)
                + DdsPixelFormat.BYTES + Integer.BYTES * (5);
    ...
    private static UncheckedImageFormat getFormat(DdsHeader ddsHeader,
            Dds10Header dds10Header) throws DdsFileUnsupportedException {
    ...
    private static int calcLineSize(UncheckedImageFormat ddsFormat, int lineWidth) {
        ...
        if(ddsFormat.bitDepth == BitDepth.COMPRESSED) {
            ...
            int blockSize = 16;
            if(ddsFormat.type == ImageFormat.PixelDataType.COMPRESSED_BC1
                    || ddsFormat.type == ImageFormat.PixelDataType.COMPRESSED_UNSIGNED_BC4
                    || ddsFormat.type == ImageFormat.PixelDataType.COMPRESSED_SIGNED_BC4)
                blockSize = 8;
    ...
    private static OldDdsFormatConv oldFormatConvert[] = {
            ...
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RGBA, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB | DdsPixelFormatFlags.ALPHAPIXELS, 32,
            ...
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            ...
                            BitDepth.PACKED_32_BIT_8888_REV, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB | DdsPixelFormatFlags.ALPHAPIXELS,
                            32, 0xff0000, 0xff00,
                            0xff, 0xff000000, 0)
            ),
            ...
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RGBX, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 32, 0xff,
                            0xff00, 0xff0000, 0, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RGB, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 24,
                            0xff, 0xff00, 0xff0000, 0, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RGB, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 24, 0xff,
                            0xff00, 0xff0000, 0, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RGB, ComponentOrder.BGRA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 24, 0xff0000,
                            0xff00, 0xff, 0, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RGB, ComponentOrder.RGBA, BitDepth.PACKED_16_BIT_565, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 16, 0xf800,
                            0x7e0, 0x1f, 0, 0)
            ),
            ...
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RGBA, ComponentOrder.BGRA,
                            BitDepth.PACKED_16_BIT_4444_REV, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 16, 0xf00,
                            0xf0, 0xf, 0xf000, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.COMPRESSED_BC1,
                            PixelComponents.COLOR_RGB, ComponentOrder.COMPRESSED, BitDepth.COMPRESSED, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0,
                            0, 0, 0, MagicNumbers.DDSFOURCC_DXT1)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.COMPRESSED_BC2,
                            PixelComponents.COLOR_RGBA, ComponentOrder.COMPRESSED, BitDepth.COMPRESSED, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0,
                            0, 0, 0, MagicNumbers.DDSFOURCC_DXT3)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.COMPRESSED_BC3,
                            PixelComponents.COLOR_RGBA, ComponentOrder.COMPRESSED, BitDepth.COMPRESSED, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.FOURCC, 0, 0,
                            0, 0, 0, MagicNumbers.DDSFOURCC_DXT5)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RG, ComponentOrder.RGBA, BitDepth.PER_COMP_16, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 32, 0xffff,
                            0xffff0000, 0, 0, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RG, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.RGB, 16, 0xffff,
                            0xffff0000, 0, 0, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RED, ComponentOrder.RGBA, BitDepth.PER_COMP_16, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.LUMINANCE, 16, 0xffff,
                            0, 0, 0, 0)
            ),
            
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RED, ComponentOrder.RGBA, BitDepth.PER_COMP_8, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.LUMINANCE, 8, 0xff,
                            0, 0, 0, 0)
            ),
            ...
            new OldDdsFormatConv(
                    new UncheckedImageFormat(ImageFormat.PixelDataType.NORM_UNSIGNED_INTEGER,
                            PixelComponents.COLOR_RG, ComponentOrder.RGBA, BitDepth.PER_COMP_16, 1),
                    new OldDdsFmtMatch(DdsPixelFormatFlags.LUMINANCE | DdsPixelFormatFlags.ALPHAPIXELS,
                            16, 0xffff, 0, 0, 0xffff0000, 0)
            ),
    ...
    private static boolean doesMatchFormat(OldDdsFmtMatch ddsFmt, DdsHeader ddsHeader) {
        ...
        if((ddsFmt.flags & DdsPixelFormatFlags.FOURCC) != 0) {
            ...
            if(ddsHeader.ddsPixelFormat.rgbBitCount != ddsFmt.bitDepth) return false;
