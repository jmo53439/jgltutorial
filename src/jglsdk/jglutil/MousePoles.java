...
public class MousePoles {
    ...
    public static abstract class Pole {
        ...
        public abstract void mouseClick(MouseButtons button, boolean isPressed,
                MouseModifiers modifiers, Vector2i position);
    ...
    public static class ObjectPole extends Pole {
        ...
        public ObjectPole(ObjectData initialData, float rotateScale,
                MouseButtons actionButton, ViewProvider lookAtViewProvider) {
        ...
        @Override
        public void mouseClick(MouseButtons button, boolean isPressed,
                MouseModifiers modifiers, Vector2i position) {
        ...
        private void rotateWorldDegrees(Quaternionf rot, boolean fromInitial) {
            ...
            objectData.orientation = new Quaternionf(rot)
                    .mul(fromInitial ? startDragOrient : objectData.orientation).normalize();
        }
        ...
        private void rotateViewDegrees(Quaternionf rot, boolean bFromInitial) {
            ...
            if(viewProvider != null) {
                ...
                objectData.orientation = tmp
                        .mul(viewQuat)
                        .mul(bFromInitial ? startDragOrient : objectData.orientation);
        ...
        private Quaternionf calcRotationQuat(int axis, float degAngle) {
            ...
            return new Quaternionf()
                    .setAngleAxis((float) Math.toRadians(degAngle), axisVectors[axis].x,
                            axisVectors[axis].y, axisVectors[axis].z);
        }
    ...
    public static class ViewPole extends ViewProvider {
        ...
        public ViewPole(ViewData initialView, ViewScale viewScale,
                MouseButtons actionButton, boolean rightKeyboardCtrls) {
        ...
        public Matrix4f calcMatrix() {
            ...
            Quaternionf angleAxis = new Quaternionf()
                    .setAngleAxis((float) Math.toRadians(currView.degSpinRotation),
                            0.0f, 0.0f, 1.0f);
        ...
        private void processXChange(int diffX, boolean clearY) {
            ...
            Quaternionf angleAxisY = new Quaternionf()
                    .setAngleAxis((float) Math.toRadians(degAngleDiff),
                            0.0f, 1.0f, 0.0f);
        ...
        private void processYChange(int diffY, boolean clearXZ) {
            ...
            Quaternionf angleAxisX = new Quaternionf()
                    .setAngleAxis((float) Math.toRadians(degAngleDiff),
                            1.0f, 0.0f, 0.0f);
        ...
        private void processXYChange(int diffX, int diffY) {
            ...
            // Rotate about the world-space Y axis.
            Quaternionf angleAxisY = new Quaternionf()
                    .setAngleAxis((float) Math.toRadians(degXAngleDiff),
                            0.0f, 1.0f, 0.0f);
            currView.orient = new Quaternionf(startDragOrient).mul(angleAxisY);
            
            // Rotate about the local-space X axis.
            Quaternionf angleAxisX = new Quaternionf()
                    .setAngleAxis((float) Math.toRadians(degYAngleDiff),
                            1.0f, 0.0f, 0.0f);
